      ...
      <div className="max-w-2xl mx-auto relative z-10">
        ...
        <div className="flex items-center gap-4 mb-6">
          ...
          <div className="flex items-center gap-2">
            ...
            <h1 className="font-pixel text-sm text-pixel-yellow">Iniciar Conversa</h1>
          </div>
        </div>
          ...
          <div className="space-y-4">
              ...
              >
                {selectedImage ? (
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="font-pixel text-[9px] text-muted-foreground">Upload de foto de pessoa ou atividade</p>
                  </div>
                )}
              </div>
            </PixelCard>
            ...
            <PixelCard>
              ...
              {!showContext ? (
                ...
                <Textarea 
                  placeholder="Ex: Este é meu amigo Adun. Estou interessado nela..." 
