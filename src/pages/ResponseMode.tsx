        ...
        {!suggestions.length ? <div className="space-y-6">
            ...
            <Card className="p-6">
              ...
              {!showContext ? <Button variant="outline" onClick={() => setShowContext(true)}>
                  Adicionar contexto +
                </Button> : <Textarea placeholder="Se há algo que você quer que eu considere apenas lmk" value={additionalContext} onChange={e => setAdditionalContext(e.target.value)} className="min-h-24" />}
            </Card>
