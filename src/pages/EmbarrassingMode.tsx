      ...
      <div className="max-w-2xl mx-auto relative z-10">
        ...
        <div className="flex items-center gap-4 mb-6">
          ...
          <div className="flex items-center gap-2">
            ...
            <h1 className="font-pixel text-sm text-pixel-yellow">Situação Embaraçosa</h1>
          </div>
        </div>
        ...
        {!suggestions.length ? (
          <div className="space-y-4">
            ...
            <PixelCard>
              <h2 className="font-pixel text-xs text-pixel-yellow mb-3">Descreva a situação</h2>
              <Textarea 
                placeholder="Conte-nos o que aconteceu..." 
                value={situation} 
                onChange={e => setSituation(e.target.value)} 
                className="min-h-28 font-pixel text-[10px] bg-pixel-purple-dark border-pixel-purple-light/30 text-foreground placeholder:text-muted-foreground" 
              />
            </PixelCard>
            ...
            <Button 
              ...
              disabled={loading || !selectedTone || situation.trim().length < 5} 
              size="lg" 
          ...
          <div className="space-y-4">
            <div className="text-center mb-6">
              ...
              <p className="font-pixel text-[9px] text-muted-foreground">Formas de lidar com a situação</p>
            </div>
